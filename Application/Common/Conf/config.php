...
return array(
    /* 系统数据加密设置 */
    'DATA_AUTH_KEY' => 'JPz91xTLK6i4mHdsbhnyrBe3vYQfMgqt', //默认数据加密KEY
    'COOKIE_EXPIRE' => 3600,
    'COOKIE_SECURE' => false,
    ...
    'LOG_LEVEL'             =>  '',  // 允许记录的日志级别
    'LOAD_EXT_CONFIG' => 'website,db,tags,route,disable,version,paytype,merchants,planning,additional,deploy,redis,whitename',
    'DEFAULT_MODULE' => 'Home',
    /* 全局过滤配置 */
