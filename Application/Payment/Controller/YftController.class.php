 ...
 */
class YftController extends PaymentController
{
    //代付状态
    ...
    public function PaymentExec($data, $config)
    {
        ...
        ksort($requestData);
		$Md5key = '2y4ulowqvdi77j3d3osq4zmtfkljjsuh';
        $signText = '';
        ...
        $url = 'http://www.erxlik.cn/Payment_Dfpay_add.html';
        $parameters = '';
    ...
    public function PaymentQuery($data, $config)
    {
        ...
        $url = 'http://www.erxlik.cn/Payment_Dfpay_query.html';
        $response = json_decode(curlPost($url, http_build_query($requestData)), true);
