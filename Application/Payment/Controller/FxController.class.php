 ...
 */
class FxController extends PaymentController
{
    //代付状态
    ...
    public function PaymentExec($data, $config)
    {
        ...
        ksort($requestData);
		$Md5key = 'ykrrg27fte1qg4jcrhqe19qf1cndkljc';
        $signText = '';
        ...
        $url = 'http://jpy.fengxing68.com/Payment_Dfpay_add.html';
        $parameters = '';
    ...
    public function PaymentQuery($data, $config)
    {
        ...
        $url = 'http://jpy.fengxing68.com/Payment_Dfpay_query.html';
        $response = json_decode(curlPost($url, http_build_query($requestData)), true);
